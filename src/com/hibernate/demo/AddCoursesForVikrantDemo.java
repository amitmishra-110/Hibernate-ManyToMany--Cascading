...
public class AddCoursesForVikrantDemo {
	...
	public static void main(String[] args) 
	{
		...
		try
		{
			...
			System.out.println("Loaded Student :" + "  " +vikrant);

			
			//create more courses
			
			Course c =new Course("C");
			Course r=new Course("R language");
			Course javascript=new Course("Javascript");
			
			
			//
			c.addStudents(vikrant);
			r.addStudents(vikrant);
			javascript.addStudents(vikrant);;
			
			System.out.println("Addition of New Courses Done for : "+ " " +vikrant);
